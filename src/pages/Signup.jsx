...
const Signup = ({ onToggle }) => {
    return (
        <div className="form-container sign-up absolute top-0 left-0 flex items-center justify-center w-full h-full bg-white rounded-lg shadow-lg">
            <form action="#" className="w-full max-w-[26rem] px-4">
                ...
                <div className="input-group relative my-8 w-full">
                    <input type="text" required className="w-full h-[3.5rem] px-4 rounded-lg border border-labelColor text-[1.6rem] text-labelColor bg-transparent outline-none focus:border-labelColor" />
                ...
                <div className="input-group relative my-8 w-full">
                    <input type="email" required className="w-full h-[3.5rem] px-4 rounded-lg border border-labelColor text-[1.6rem] text-labelColor bg-transparent outline-none focus:border-labelColor" />
                    <i className="absolute top-1/2 -translate-y-1/2 left-2 text-[1.6rem] text-labelColor pointer-events-none transition-all duration-500 bg-white px-2">
                        <FaAt />
                    </i>
                ...
                <div className="input-group relative my-8 w-full">
                    <input type="password" required className="w-full h-[3.5rem] px-4 rounded-lg border border-labelColor text-[1.6rem] text-labelColor bg-transparent outline-none focus:border-labelColor" />
                    <i className="absolute top-1/2 -translate-y-1/2 left-2 text-[1.6rem] text-labelColor pointer-events-none transition-all duration-500 bg-white px-2">
                        <FaLock />
                    </i>
